...
public class Stemmer {
	...
	public void readStopword() {
		...
		try {
			br = new BufferedReader(new FileReader("D:\\EProgramFiles\\DMClassify\\DM\\runtime\\stopwords.txt"));
			bw = new BufferedWriter(new FileWriter("D:\\EProgramFiles\\DMClassify\\DM\\runtime\\log.txt"));
